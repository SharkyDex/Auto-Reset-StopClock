...
class StopwatchApp:
    def __init__(self, root):
        ...
        self.last_click_label = tk.Label(root, text="Last Click: --:--:--", font=("Arial", 16))
    ...
    def play_alert_sound(self):
        ...
        while datetime.now().timestamp() < end_time and self.alert_active:
            continue
    ...
    def on_click(self, x, y, button, pressed):
        ...
        try:
            ...
            if "chrome" in title_lower and "chrome_widgetwin" in class_lower:
                ...
                if left <= x <= right and top <= y <= bottom:
                    ...
                    self.last_click_label.config(text=f"Last Click: {now_str}")
        except:
